...
<body>
    ...
    <div class='header'>
        <div class='watermark-box'><a href='https://t.me/DREAM_NEET' target='_blank'>VIVEK KRISHNA</a></div>
        <h1>{test_title}</h1>
        <div class='details'>
    ...
    <div class='questions-container'>
        ...
        <div class='question'>
            <div class='question-number'>
                ...
                <span class='question-watermark'><a href='https://t.me/DREAM_NEET' target='_blank'>VIVEK KRISHNA</a></span>
            </div>
...
<body>
    ...
    <div class='question-container'>
        <a href='https://t.me/DREAM_NEET' target='_blank' class='question-watermark'>VIVEK KRISHNA</a>
...
<body>
    ...
    for idx, q in enumerate(data, 1):
        ...
        html += f"""
    <div class='question-container'>
        <div class='question-watermark'>VIVEK KRISHNA</div>
        <div class='question-header'>
            <div class='question-number'>{idx}</div>
        </div>
        <div class='question-text'>{processed_body}</div>
...
def generate_solutions_html(data, test_title):
    """Generate HTML with answer key table and detailed solutions — Blue Theme"""
    answer_key_rows = ""
    for idx, q in enumerate(data, 1):
...
<style>
    ...
    * {{
    ...
    body {{
        ...
        background: linear-gradient(160deg, var(--blue-50) 0%, #e8f1fd 100%);
        color: var(--text-dark);
        padding: 28px 20px;
        line-height: 1.65;
        max-width: 1200px;
    ...
    .answer-key-section {{
        ...
        padding: 28px;
        margin-bottom: 48px;
        box-shadow: 0 6px 30px rgba(37, 99, 176, 0.12);
    ...
    .answer-key-title {{
        ...
        letter-spacing: 2px;
        text-transform: uppercase;
        box-shadow: 0 4px 18px rgba(13, 34, 69, 0.25);
    }}
    ...
    .answer-key-table {{
        ...
        border-radius: 10px;
        overflow: hidden;
        box-shadow: 0 2px 12px rgba(37, 99, 176, 0.10);
    ...
    .solution-container {{
        ...
        margin-bottom: 28px;
        page-break-inside: avoid;
        box-shadow: 0 3px 16px rgba(37, 99, 176, 0.08);
        position: relative;
        transition: box-shadow 0.2s ease;
    }}

    .solution-container:hover {{
        box-shadow: 0 6px 24px rgba(37, 99, 176, 0.14);
    }}
    ...
    .question-watermark {{
        ...
        padding: 7px 15px;
        border-radius: 20px;
        border: 1.5px solid rgba(37, 99, 176, 0.22);
        font-size: 13px;
        font-weight: bold;
        color: rgba(37, 99, 176, 0.75);
        text-decoration: none;
    ...
    .question-watermark:hover {{
        ...
        border-color: rgba(37, 99, 176, 0.45);
        color: var(--blue-600);
        transform: scale(1.04);
    }}

    /* Solution number bubble */
    .solution-header {{
        display: flex;
        align-items: center;
        margin-bottom: 18px;
    ...
    .solution-number {{
        ...
        font-weight: bold;
        font-size: 17px;
        box-shadow: 0 3px 10px rgba(37, 99, 176, 0.35);
        flex-shrink: 0;
    }}
    ...
    /* ── Print ─────────────────────────────────────────── */
    @media print {{
        .answer-key-section    {{ page-break-after: always; }}
        .detailed-solutions-section {{ page-break-before: always; }}
        .solution-container    {{ page-break-inside: avoid; }}
    }}

    /* ── Responsive ────────────────────────────────────── */
    @media (max-width: 768px) {{
        body {{ padding: 14px; }}
        .test-title-large {{ font-size: 20px; }}
        .answer-key-table th,
        .answer-key-table td {{ padding: 8px 6px; font-size: 13px; }}
        .table-answer-text {{ padding-left: 8px; }}
        .solution-header {{ flex-direction: column; align-items: flex-start; }}
        .solution-number {{ margin-right: 0; margin-bottom: 10px; }}
        .question-watermark {{ top: 12px; right: 14px; padding: 5px 11px; font-size: 11px; }}
    }}
</style>
</head>
<body>
